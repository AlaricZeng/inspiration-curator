    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>
          Connect your accounts to start the daily scrape. Instagram opens a
          browser window for login; Xiaohongshu uses cookie import below.
        </p>
              ...
              <div key="xiaohongshu" style={{ ...styles.platformRow, flexDirection: "column", alignItems: "stretch", gap: "0.85rem" }}>
                ...
                <div style={styles.cookieBox}>
                  <p style={styles.cookieHint}>
                    ...
                    , log in to xiaohongshu.com in Chrome, then click <strong>Export → Export as JSON</strong> and paste below.
